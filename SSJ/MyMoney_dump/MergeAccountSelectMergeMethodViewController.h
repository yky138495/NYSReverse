...
@class AccountVo, NSIndexPath, NSString;

@interface MergeAccountSelectMergeMethodViewController : BaseTableViewController <UITableViewDelegate, UITableViewDataSource>
{
