...
- (void)dealloc;
- (id)buttonWithNormalImage:(id)arg1 highlightedImage:(id)arg2 selectedImage:(id)arg3;
- (id)searchButtonWithNormalImage:(id)arg1 highlightedImage:(id)arg2 selectedImage:(id)arg3;
