...
@interface BatchDataOperationController : BaseTabSettingViewController
{
...
- (id)tableViewDidSelectAccountBookImportRow;
- (void)tableView:(id)arg1 didSelectRowAtIndexPath:(id)arg2;
- (double)tableView:(id)arg1 heightForHeaderInSection:(long long)arg2;
- (id)tableView:(id)arg1 viewForHeaderInSection:(long long)arg2;
- (id)tableView:(id)arg1 cellForAccountBookImportSectionRowAtIndexPath:(id)arg2;
- (id)tableView:(id)arg1 cellForDeleteAndMergeSectionRowAtIndexPath:(id)arg2;
