...
@interface IntroduceUsController : BaseTableViewController <FDWeChatAPIManagerDelegate, MFMessageComposeViewControllerDelegate>
{
}
...
- (void)introduceUsViaSMS;
- (void)introduceUsViaWechatToFriend:(_Bool)arg1;
