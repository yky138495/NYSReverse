...
@interface FinanceWalletActivityCell : UITableViewCell
{
    id <FinanceWalletActivityCellDataSource> _dataSource;
...
@property(nonatomic) __weak id <FinanceWalletActivityCellDataSource> dataSource; // @synthesize dataSource=_dataSource;
- (void).cxx_destruct;
- (void)layoutSubviews;
